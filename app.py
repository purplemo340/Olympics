...
def game(city):
     info=pd.read_csv(f'results/{city}.csv')
     ...
     if request.method=="POST":
        ...
        print(game)
        return redirect(url_for('game', city=game))
     return render_template('game.html', city=city, games=games_info['City-Year'], countries=countries, abv=abv, length=length)
